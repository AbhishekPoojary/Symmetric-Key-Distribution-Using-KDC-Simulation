...
def main():
    ...
    while True:
        ...
        if 'wait' in message:
            ...
            print("\n" + "="*60)
            print("  Bob: Received Envelope from Alice (Step 3)")
            print("="*60)
            ...
            if not timestamp_valid:
                print("  [!] TIMESTAMP EXPIRED — possible replay attack! Rejecting.")
